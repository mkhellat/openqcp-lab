# Phase 2: cProfile / line_profiler / py-spy baseline

Scoped in `../../PLAN.md` Section 5 (Phase 2), profiled 2026-08-16.
This directory holds the artifacts behind Phase 2's write-up — see
...
Reproduce (from `tools/paulikit/`):

```bash
# cProfile
python3 -m cProfile -o profiling/phase2/cprofile_n50.prof profiling/phase2/profile_target.py
snakeviz profiling/phase2/cprofile_n50.prof   # interactive flame graph, browser GUI
...
# py-spy
py-spy record -o profiling/phase2/pyspy_n50.svg -- python3 profiling/phase2/profile_target.py
```
