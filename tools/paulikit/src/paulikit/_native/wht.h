 ...
 * used by paulikit.algorithms.fwht (Phase 14).
 *
 ...
 *
 * See profiling/phase14/ for the harnesses and the full write-up.
 */
 ...
 *
 * A hardcoded tile is the portability failure Phase 12's autotuner
